  ...
  categories = [
    ...
    { name: 'Business', url: 'https://www.udemy.com/courses/business/', subs: [
      ...
      { name: 'Business Analytics & Intelligence', url: 'https://www.udemy.com/courses/business/analytics-and-intelligence/', subs: [
        { name: 'All Business Analytics & Intelligence', url: 'https://www.udemy.com/courses/business/analytics-and-intelligence/' },
        { name: 'Microsoft Power BI', url: 'https://www.udemy.com/topic/microsoft-power-bi/' },
        { name: 'SQL', url: 'https://www.udemy.com/topic/sql/' },
        { name: 'Tableau', url: 'https://www.udemy.com/topic/tableau/' },
        { name: 'Business Analysis', url: 'https://www.udemy.com/topic/business-analysis/' },
        { name: 'Data Modeling', url: 'https://www.udemy.com/topic/data-modeling/' },
        { name: 'Business Intelligence', url: 'https://www.udemy.com/topic/business-intelligence/' },
        { name: 'MySQL', url: 'https://www.udemy.com/topic/mysql/' },
        { name: 'Data Analysis', url: 'https://www.udemy.com/topic/data-analysis/' },
        { name: 'Blockchain', url: 'https://www.udemy.com/topic/blockchain/' },
      ] },
      { name: 'Human Resources', url: 'https://www.udemy.com/courses/business/human-resources/', subs: [
        { name: 'All Human Resources', url: 'https://www.udemy.com/courses/business/human-resources/' },
        { name: 'Recruiting', url: 'https://www.udemy.com/topic/recruiting/' },
        { name: 'HR Analytics', url: 'https://www.udemy.com/topic/hr-analytics/' },
        { name: 'Instructional Design', url: 'https://www.udemy.com/topic/instructional-design/' },
        { name: 'Hiring', url: 'https://www.udemy.com/topic/hiring/' },
        { name: 'Emotional Intelligence', url: 'https://www.udemy.com/topic/emotional-intelligence/' },
        { name: 'Diversity and Inclusion', url: 'https://www.udemy.com/topic/diversity/' },
        { name: 'Conflict Management', url: 'https://www.udemy.com/topic/conflict-management/' },
        { name: 'Employment Law', url: 'https://www.udemy.com/topic/employment-law/' },
      ] },
