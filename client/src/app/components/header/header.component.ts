      ...
      name: 'Health & Fitness', uri: 'https://www.udemy.com/courses/health-and-fitness/', subs: [
        ...
        },
        {
          name: 'Nutrition', uri: 'https://www.udemy.com/courses/health-and-fitness/nutrition/', subs: [
            ...
            { name: 'Dieting', uri: 'https://www.udemy.com/topic/dieting/' },
            { name: 'Sports Nutrition', uri: 'https://www.udemy.com/topic/sports-nutrition/' },
            { name: 'Vegan Cooking', uri: 'https://www.udemy.com/topic/vegan-cooking/' },
            { name: 'Ketogenic Diet', uri: 'https://www.udemy.com/topic/ketogenic-diet/' },
            { name: 'Gut Health', uri: 'https://www.udemy.com/topic/gut-health/' },
      ...
      name: 'Music', uri: 'https://www.udemy.com/courses/music/', subs: [
        ...
        },
        {
          name: 'Vocal', uri: 'https://www.udemy.com/courses/music/vocal/', subs: [
            { name: 'Singing', uri: 'https://www.udemy.com/topic/singing/' },
            { name: 'Voice Training', uri: 'https://www.udemy.com/topic/voice-training/' },
            { name: 'Voice Acting', uri: 'https://www.udemy.com/topic/voice-acting/' },
            { name: 'Rapping', uri: 'https://www.udemy.com/topic/rapping/' },
            { name: 'Raga Music', uri: 'https://www.udemy.com/topic/raga-music/' },
            { name: 'Yoga', uri: 'https://www.udemy.com/topic/yoga/' },
            { name: 'Carnatic Music', uri: 'https://www.udemy.com/topic/carnatic-music/' },
            { name: 'Mindset', uri: 'https://www.udemy.com/topic/mindset/' },
            { name: 'Coaching', uri: 'https://www.udemy.com/topic/coaching/' },
          ]
        },
        {
          name: 'Music Techniques', uri: 'https://www.udemy.com/courses/music/music-techniques/', subs: [
            { name: 'Fingerstyle Guitar', uri: 'https://www.udemy.com/topic/fingerstyle-guitar/' },
            { name: 'Music Composition', uri: 'https://www.udemy.com/topic/music-composition/' },
            { name: 'Reading Music', uri: 'https://www.udemy.com/topic/reading-music/' },
            { name: 'Piano', uri: 'https://www.udemy.com/topic/piano/' },
            { name: 'Guitar', uri: 'https://www.udemy.com/topic/guitar/' },
            { name: 'Blues Guitar', uri: 'https://www.udemy.com/topic/blues-guitar/' },
            { name: 'Music Improvisation', uri: 'https://www.udemy.com/topic/music-improvisation/' },
            { name: 'Piano Chords', uri: 'https://www.udemy.com/topic/piano-chords/' },
            { name: 'Harmony', uri: 'https://www.udemy.com/topic/harmony/' },
          ]
        },
        {
